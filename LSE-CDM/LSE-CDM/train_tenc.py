...
parser.add_argument('--diffuser_type',type=str, default='mlp1', help='the type of diffusion model: Tenc')
...
train_data, valid_y_data, test_y_data, train_seqs, train_seq_lens, real_count, n_user, n_item = data_utils.data_load(train_path, valid_path, test_path, args.seq_length)
...
train_dataset = data_utils.FullTrainDataset(train_dense, train_seqs, train_seq_lens, real_count)
