...
import models.gaussian_diffusion_old as gd
...
train_data, valid_y_data, test_y_data, n_user, n_item = data_utils_old.data_load(train_path, valid_path, test_path)
train_dataset = data_utils_old.DataDiffusion(torch.FloatTensor(train_data.A))
...
if args.tst_w_val:
    tv_dataset = data_utils_old.DataDiffusion(torch.FloatTensor(train_data.A) + torch.FloatTensor(valid_y_data.A))
